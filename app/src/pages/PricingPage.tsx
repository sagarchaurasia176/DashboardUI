    ...
    >
      ...
      <ul className="space-y-3 mb-6">
        {features.map((feature, index) => (
          <li key={index} className="flex items-center md:text-lg">
            <svg
  ...
  return (
    <section className="bg-slate-950 h-screen">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center relative sm:top-10 ">
          <motion.h2
            initial={{ opacity: 0, y: -20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
          ...
          >
            Select the plan that best fits your needs and start creating amazing
            projects today
          </motion.p>
        </div>
        <div className="sm:grid sm:grid-cols-2  lg:flex lg:justify-center lg:items-center gap-8 sm:mt-20 md:mt-20">
