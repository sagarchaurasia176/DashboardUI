...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      <header
        className={`sticky top-0 z-50 shadow-lg w-full transition-all  p-3 lg:p-4 duration-300 ${
      ...
      >
        ...
        <div className="flex items-center justify-between p-1  ">
          ...
          <Link
            to="/"
            className="flex items-center font-bold text-sm sm:text-lg md:text-sm lg:text-1xl"
          >
            <img className="w-8 h-8" src={logo} alt="Logo of Dashboard_UI" />
            <span className=" ml-0 lg:ml-2 sm:ml-0  font-extrabold   text-xl lg:text-2xl  ">
              Dashboard_UI
            </span>
          </Link>
