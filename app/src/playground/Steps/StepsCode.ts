            ...
            <div key={index} className="flex relative pb-12">
              ...
              <div className="flex-shrink-0 w-10 h-10 rounded-full bg-blue-600 inline-flex items-center justify-center text-white relative z-10">
                <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-5 h-5" viewBox="0 0 24 24">
                  <path d={index === 0 ? "M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" : index === 1 ? "M22 12h-4l-3 9L9 3l-3 9H2" : index === 2 ?
                   "M12 22V8M5 12H2a10 10 0 0020 0h-3" : "M20 21v-2a4 4 0 00-4-4H8a4 4 0 00-4 4v2"} />
                </svg>
              </div>
