const ContactCode = {
  ...
  <div class="container px-5 py-24 mx-auto flex items-center justify-center">
    <div
      class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 shadow-lg relative z-10"
    >
      <h2 class="text-gray-900 text-2xl font-semibold mb-4">We'd love to hear from you!</h2>
      <p class="text-gray-600 mb-6">
        Feel free to share your feedback, thoughts, or questions. We're here to
        help!
      </p>
