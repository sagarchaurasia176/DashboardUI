        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-16 md:pr-8 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-gray-600">
              Step into a world where creativity meets technology. From
              cutting-edge designs to sustainable solutions, our journey
              redefines possibilities.
            </p>
            <div className="flex justify-center">
              <button className="inline-flex text-white bg-blue-600 border-0 py-2 px-8 focus:outline-none hover:bg-blue-700 rounded-lg shadow-lg text-lg">
                Get Started
              </button>
              <button className="ml-4 inline-flex text-blue-600 bg-white border-2 border-blue-600 py-2 px-8 focus:outline-none hover:bg-blue-50 rounded-lg shadow-lg text-lg">
                Learn More
              </button>
            </div>
          </div>
